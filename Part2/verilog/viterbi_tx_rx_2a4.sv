// Part 2.a.4: Invert bit[0] TWICE in a row, every 16 samples  (BER = 2/32 = 1/16)
// Pattern: 14 clean, 2 bad (bit[0]), 14 clean, 2 bad, ...
...
module viterbi_tx_rx #(parameter N=4) (
   ...
   always @ (posedge clk, negedge rst)
      if (!rst) begin
         $display("2.a.4: bit[0] x2 every 16 (14 good, 2 bad)");
         error_counter        <= 0;
         bad_bit_ct           <= 0;
         encoder_o_reg        <= 0;
         encoder_o_reg0       <= 0;
         ...
         // trigger at positions 14,15 of every 16 -> 2 consecutive injections

// Part 2.a.7: Invert bit[1] FOUR times in a row, every 32 samples  (BER = 4/64 = 1/16)
// Pattern: 28 clean, 4 bad (bit[1]), 28 clean, 4 bad, ...
...
module viterbi_tx_rx #(parameter N=4) (
   ...
   always @ (posedge clk, negedge rst)
      if (!rst) begin
         $display("2.a.7: bit[1] x4 every 32 (28 good, 4 bad)");
         error_counter        <= 0;
         bad_bit_ct           <= 0;
         encoder_o_reg        <= 0;
         encoder_o_reg0       <= 0;

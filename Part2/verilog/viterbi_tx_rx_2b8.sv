// Part 2.b.8: Random version of 2.a.8 -- random 2-consecutive both-bit bursts
// Average: ~1 burst per 32 cycles  (trigger prob 1/32 per sample, burst length 2)
module viterbi_tx_rx #(parameter N=4) (
   ...
   always @ (posedge clk, negedge rst)
      if (!rst) begin
         $display("2.b.8: random 2-burst bit[0]+bit[1], avg 1 burst per 32");
         error_counter        <= 0;
         bad_bit_ct           <= 0;
         encoder_o_reg        <= 0;
         encoder_o_reg0       <= 0;

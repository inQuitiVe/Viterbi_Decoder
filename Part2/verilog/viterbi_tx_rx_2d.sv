// Part 2.d: Find minimum consecutive bit[1] errors needed to cause decoder output errors
//
// BURST_LEN: number of consecutive samples in which bit[1] is inverted
...
module viterbi_tx_rx #(
   ...
   always @ (posedge clk, negedge rst)
      if (!rst) begin
         $display("2.d: consecutive bit[1] burst, BURST_LEN=%0d, GAP=%0d", BURST_LEN, GAP);
         error_counter        <= 0;
         bad_bit_ct           <= 0;
         encoder_o_reg        <= 0;
         encoder_o_reg0       <= 0;
